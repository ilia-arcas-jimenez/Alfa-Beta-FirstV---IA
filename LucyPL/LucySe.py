...
with open("F:/desktop/importante/PROYECTOS DE PROGRAMACION/Python/sentimientos/LucyPL/contenidoNeutro.json", ) as archivo:
...
#with open("F:/desktop/importante/PROYECTOS DE PROGRAMACION/Python/sentimientos/LucyPL/contenidoNeutro.json", ) as archivo:
#        datosNeutros = json.load(archivo)
#with open("F:/desktop/importante/PROYECTOS DE PROGRAMACION/Python/sentimientos/LucyPL/contenidoPositivo.json", ) as archivo:
#        datosPositivos = json.load(archivo)
#with open("F:/desktop/importante/PROYECTOS DE PROGRAMACION/Python/sentimientos/LucyPL/contenidoNegativo.json", ) as archivo:
